...
";
        ...
        /// </summary>
        public static string CmdFilesDir => Path.Combine(Program.ExecutingPath, "jlinkCmds");
        ...
        internal static string RunJLinkCLI(string cmdFile, string arguments = null)
        {
            ...
            string appName;
            string appDir;
            string cmdFilesDir = Path.Combine(Program.ExecutingPath, "jlinkCmds", cmdFile);

            if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
            {
                appName = "JLink.exe";
                appDir = Path.Combine(Program.ExecutingPath, "jlink");
            }
            else if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
            {
                appName = "JLinkExe";
                appDir = Path.Combine(Program.ExecutingPath, "jlinkMac");
            }
            else
            {
                appName = "JLinkExe";
                appDir = Path.Combine(Program.ExecutingPath, "jlinkLinux");
