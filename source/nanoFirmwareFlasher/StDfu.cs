...
namespace nanoFramework.Tools.FirmwareFlasher
{
    internal class StDfu
    {
        ...
        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_GetInterfaceDescriptor", CharSet = CharSet.Auto)]
        ...
        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_SelectCurrentConfiguration", CharSet = CharSet.Ansi)]
        ...
        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_GetDFUDescriptor", CharSet = CharSet.Auto)]
        ...
        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_GetDeviceDescriptor", CharSet = CharSet.Auto)]
        internal static extern uint STDFU_GetDeviceDescriptor(
            ref IntPtr handle, 
            ref UsbDeviceDescriptor descriptor);

        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_GetStringDescriptor", CharSet = CharSet.Auto)]
        ...
        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_Dnload", CharSet = CharSet.Ansi)]
        ...
        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_Getstatus", CharSet = CharSet.Ansi)]
        internal static extern uint STDFU_GetStatus(
            ref IntPtr hDevice, 
            ref DfuStatus dfuStatus);

        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_Clrstatus", CharSet = CharSet.Ansi)]
        internal static extern uint STDFU_ClrStatus(ref IntPtr hDevice);

        [DllImport(".\\costura32\\STDFU.dll", EntryPoint = "STDFU_Open", CharSet = CharSet.Ansi)]
