        ...
        public static IEnumerable<Example> Examples
        {
            get
            {
                return new List<Example>() {
                    ...
                    new Example("Update STM32 device with latest available firmware (nF org preview repository)", new Options { TargetName = "ST_STM32F769I_DISCOVERY" , Update = true}),
                    new Example("Update STM32 device with latest available firmware (nf org preview repository), device is connected through DFU with Id 3380386D3134", new Options { TargetName = "NETDUINO3_WIFI",  Update = true, DfuDeviceId = "3380386D3134" }),
